...
// GAME OF THRONES
  ...
  await db.insert('episodios',
      {'nome': 'Baelor - Baelor', 'tempo': 62, 'episodio': 9, 'temporada': 1});
  ...
  await db.insert('episodios',
      {'nome': 'Mhysa - Mhysa', 'tempo': 62, 'episodio': 10, 'temporada': 3});
  ...
  await db.insert('episodios',
      {'nome': 'Home - Lar', 'tempo': 62, 'episodio': 2, 'temporada': 6});
  ...
  await db.insert('episodios',
      {'nome': 'No One - Ninguém', 'tempo': 62, 'episodio': 8, 'temporada': 6});
  ...
  await db.insert('episodios', {
    'nome': 'The Last of the Starks - O Último dos Stark',
    'tempo': 62,
    'episodio': 4,
    'temporada': 8
  });
  ...
  await db.insert('episodios', {
    'nome': 'Iron Throne - O Trono de Ferro',
    'tempo': 62,
    'episodio': 6,
    'temporada': 8
  });
  ...
  await db.insert('episodios',
      {'nome': 'Pilot - Piloto', 'tempo': 58, 'episodio': 1, 'temporada': 1});

  await db.insert('episodios', {
    'nome': 'Cat’s in the Bag… - Gatos no Saco...',
    'tempo': 48,
    'episodio': 2,
    'temporada': 1
  });
  ...
  await db.insert('episodios', {
    'nome': '…And the Bag’s in the River - ...E o Saco Está no Rio',
    'tempo': 48,
    'episodio': 3,
    'temporada': 1
  });
  ...
  await db.insert('episodios', {
    'nome': 'Cancer Man - O Homem do Câncer',
    'tempo': 47,
    'episodio': 4,
    'temporada': 1
  });
  ...
  await db.insert('episodios', {
    'nome': 'Gray Matter - Matéria Cinza',
    'tempo': 48,
    'episodio': 5,
    'temporada': 1
  });
  ...
  await db.insert('episodios', {
    'nome': 'Crazy Handful of Nothin’ - Um Punhado de Nada',
    'tempo': 48,
    'episodio': 6,
    'temporada': 1
  });
  ...
  await db.insert('episodios', {
    'nome': 'Bit by a Dead Bee - Picado por uma Abelha Morta',
    'tempo': 47,
    'episodio': 3,
    'temporada': 2
  });
  ...
  await db.insert('episodios',
      {'nome': 'Down - Em Queda', 'tempo': 47, 'episodio': 4, 'temporada': 2});

  await db.insert('episodios', {
    'nome': 'Breakage - Quebra',
    'tempo': 48,
    'episodio': 5,
    'temporada': 2
  });
  ...
  await db.insert('episodios', {
    'nome': 'Negro y Azul - Negro e Azul',
    'tempo': 48,
    'episodio': 7,
    'temporada': 2
  });
  ...
  await db.insert('episodios', {
    'nome': 'Better Call Saul - Melhor Chamar o Saul',
    'tempo': 47,
    'episodio': 8,
    'temporada': 2
  });
  ...
  await db.insert('episodios',
      {'nome': 'Over - Acabou', 'tempo': 48, 'episodio': 10, 'temporada': 2});

  await db.insert('episodios', {
    'nome': 'Mandala - Mandala',
    'tempo': 48,
    'episodio': 11,
    'temporada': 2
  });
  ...
  await db.insert('episodios',
      {'nome': 'Phoenix - Fênix', 'tempo': 48, 'episodio': 12, 'temporada': 2});

  await db.insert('episodios',
      {'nome': 'ABQ - ABQ', 'tempo': 48, 'episodio': 13, 'temporada': 2});

  await db.insert('episodios',
      {'nome': 'No Mas - Chega', 'tempo': 47, 'episodio': 1, 'temporada': 3});

  await db.insert('episodios', {
    'nome': 'Caballo Sin Nombre - Cavalo Sem Nome',
    'tempo': 47,
    'episodio': 2,
    'temporada': 3
  });
  ...
  await db.insert('episodios',
      {'nome': 'I.F.T. - I.F.T.', 'tempo': 47, 'episodio': 3, 'temporada': 3});

  await db.insert('episodios', {
    'nome': 'Green Light - Sinal Verde',
    'tempo': 48,
    'episodio': 4,
    'temporada': 3
  });
  ...
  await db.insert('episodios',
      {'nome': 'Más - Mais', 'tempo': 48, 'episodio': 5, 'temporada': 3});

  await db.insert('episodios', {
    'nome': 'Sunset - Pôr do Sol',
    'tempo': 48,
    'episodio': 6,
    'temporada': 3
  });
  ...
  await db.insert('episodios', {
    'nome': 'Kafkaesque - Kafkiano',
    'tempo': 48,
    'episodio': 9,
    'temporada': 3
  });
  await db.insert('episodios',
      {'nome': 'Fly - Mosca', 'tempo': 48, 'episodio': 10, 'temporada': 3});

  await db.insert('episodios', {
    'nome': 'Abiquiú - Abiquiú',
    'tempo': 48,
    'episodio': 11,
    'temporada': 3
  });
  ...
  await db.insert('episodios', {
    'nome': 'Half Measures - Medidas Metade',
    'tempo': 48,
    'episodio': 12,
    'temporada': 3
  });
  ...
  await db.insert('episodios', {
    'nome': 'Full Measure - Medida Completa',
    'tempo': 48,
    'episodio': 13,
    'temporada': 3
  });
  ...
  await db.insert('episodios', {
    'nome': 'Box Cutter - Cortador de Caixa',
    'tempo': 47,
    'episodio': 1,
    'temporada': 4
  });
  ...
  await db.insert('episodios', {
    'nome': 'Thirty-Eight Snub - Desprezo .38',
    'tempo': 47,
    'episodio': 2,
    'temporada': 4
  });
  ...
  await db.insert('episodios', {
    'nome': 'Bullet Points - Pontos de Bala',
    'tempo': 47,
    'episodio': 4,
    'temporada': 4
  });
  ...
  await db.insert('episodios', {
    'nome': 'Problem Dog - Cachorro Problema',
    'tempo': 47,
    'episodio': 7,
    'temporada': 4
  });
  ...
  await db.insert('episodios',
      {'nome': 'Bug - Inseto', 'tempo': 47, 'episodio': 9, 'temporada': 4});

  await db.insert('episodios',
      {'nome': 'Salud - Saúde', 'tempo': 47, 'episodio': 10, 'temporada': 4});

  await db.insert('episodios', {
    'nome': 'Crawl Space - Espaço Apertado',
    'tempo': 47,
    'episodio': 11,
    'temporada': 4
  });
  ...
  await db.insert('episodios', {
    'nome': 'Live Free or Die - Viva Livre ou Morra',
    'tempo': 47,
    'episodio': 1,
    'temporada': 5
  });
  ...
  await db.insert('episodios', {
    'nome': 'Hazard Pay - Pagamento de Risco',
    'tempo': 47,
    'episodio': 3,
    'temporada': 5
  });
  ...
  await db.insert('episodios',
      {'nome': 'Buyout - Compra', 'tempo': 47, 'episodio': 6, 'temporada': 5});

  await db.insert('episodios', {
    'nome': 'Say My Name - Diga Meu Nome',
    'tempo': 47,
    'episodio': 7,
    'temporada': 5
  });
  ...
  await db.insert('episodios', {
    'nome': 'Gliding Over All - Deslizando Sobre Tudo',
    'tempo': 47,
    'episodio': 8,
    'temporada': 5
  });
  ...
  await db.insert('episodios', {
    'nome': 'Blood Money - Dinheiro Sangrento',
    'tempo': 47,
    'episodio': 9,
    'temporada': 5
  });
  ...
  await db.insert('episodios', {
    'nome': 'Rabid Dog - Cachorro Raivoso',
    'tempo': 47,
    'episodio': 12,
    'temporada': 5
  });
  ...
  await db.insert('episodios',
      {'nome': 'Felina - Felina', 'tempo': 47, 'episodio': 14, 'temporada': 5});
}
